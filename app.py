...
# ======================================================
# NOUVELLE FONCTION POUR LA BARRE DE PROGRESSION
# ======================================================
...
# ======================================================
# NOUVELLE FONCTION POUR VÉRIFIER LA LIMITE DE POINTS TOTAUX
# ======================================================
...
# ======================================================
# FONCTION POUR VÉRIFIER LA LIMITE DE POINTS AVANT AJOUT
# ======================================================
def check_add_unit_points(current_points, unit_cost, max_points):
    ...
    if current_points + unit_cost > max_points:
        st.error(f"Ajouter cette unité dépasserait votre limite de {max_points} pts. Il vous reste {max_points - current_points} pts.")
        return False
    return True
...
def validate_army_rules(army_list, army_points, game, new_unit_cost=None):
    ...
    if game in GAME_CONFIG:
        ...
        # Vérification qu'ajouter une nouvelle unité ne dépasse pas la limite
        if new_unit_cost:
            test_total = sum(unit["cost"] for unit in army_list) + new_unit_cost
            if test_total > army_points:
                st.error(f"Ajouter cette unité dépasserait votre limite de {army_points} pts. Il vous reste {army_points - sum(unit['cost'] for unit in army_list)} pts.")
                return False
